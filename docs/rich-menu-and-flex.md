...
選單為 2500×843 PNG、2×2 四格，採用 AI 生成的鮮豔外星科幻底圖，再由程式疊上可精準維護的繁中文字。所有按鈕都連到現有功能，不會出現尚未完成的死入口：
...
2026-09-20 手機實機驗收後，由原本 3×2 六格收旂為 2×2 四格：移除只送出固定範例題的「觀星入門」，並合併會與「問守門人」導向同一份導覽的「功能說明」。所有功能仍可透過輸入指令使用。
